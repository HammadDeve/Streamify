...
import NoFriendsFound from "../componenets/NoFriendsFound";
...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen p-4 sm:p-6 lg:p-8 overflow-y-auto bg-base-100">
      <div className="container mx-auto space-y-10">
        ...
        {loadingFriends ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 w-full overflow-hidden">
            {friends.map((friend) => (
              <div key={friend._id} className="w-full">
          ...
          {loadingUsers ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full overflow-hidden">
              {recommendedUsers.map((user) => {
                ...
                const isPendingForThisUser = pendingUserId === user._id;

                return (
                  <div
                    key={user._id}
                    className="card bg-base-200 hover:shadow-lg transition-all duration-300 w-full"
                  >
                    <div className="card-body p-5 space-y-4">
                      ...
                      <button
                        ...
                        disabled={hasRequestBeenSent || isPendingForThisUser}
                      >
                        {hasRequestBeenSent ? (
                          <>
